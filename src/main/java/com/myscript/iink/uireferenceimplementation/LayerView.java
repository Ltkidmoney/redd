...
public class LayerView extends View
{
  ...
  protected final void onDraw(android.graphics.Canvas canvas)
  {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P)
    {
      ...
      Bitmap bg = BitmapFactory.decodeResource(getResources(), imageType == 1 ? R.drawable.image_1 : R.drawable.image_2);
//      Log.d("CANVAS WIDTH", String.valueOf(canvasWidth));
//      Log.d("CANVAS HEIGHT", String.valueOf(canvasHeight));
      canvas.drawBitmap(bg, new Rect(0, 0, bg.getWidth(), bg.getHeight()), new Rect(0, 0, canvasWidth, canvasHeight), null);
...
//      canvas.drawBitmap(bitmap, 0, 0, null);
  ...
  public void setBackImage(int number) {
    imageType = number;
    invalidate();
  }

  public void setTextFont(Typeface font) {
    Log.d("SET TEXT FONT", font.toString());
    GlobalConstant.textFamily = font;
  }
  public void setTextSize(float size) {
    Log.d("SET TEXT SIZE", String.valueOf(size));
    GlobalConstant.textSize = size;
  }
  public void setTextColor(int textColor) {
    Log.d("SET TEXT COLOR", String.valueOf(textColor));
    GlobalConstant.textColor = textColor;
  }
}