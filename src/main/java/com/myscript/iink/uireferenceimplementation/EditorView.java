...
public class EditorView extends FrameLayout implements IRenderTarget, InputController.ViewListener
{
  ...
  public void setBackImage(int number) {
    if (layerView != null) {
      layerView.setBackImage(number);
    }
  }

  public void setFontFamily(Typeface typeface) {
    if (layerView != null) layerView.setTextFont(typeface);
  }
  
  public void setTextColor(int color) {
    if (layerView != null) layerView.setTextColor(color);
  }

  public void setTextSize(float size) {
    if (layerView != null) layerView.setTextSize(size);
  }
}
