...
public class Canvas implements ICanvas
{
  ...
  public Canvas(@Nullable android.graphics.Canvas canvas, Map<String, Typeface> typefaceMap, ImageLoader imageLoader, @Nullable OfflineSurfaceManager offlineSurfaceManager, float xdpi, float ydpi)
  {
    ...
    DEFAULT_SVG_STYLE.setFontLineHeight(0.5f);
  ...
  public android.graphics.Canvas getCanvas() { return this.canvas; }
...
//    pointsCache[1] = 10;
    ...
    textPaint.setTypeface(GlobalConstant.textFamily);
    textPaint.setTextSize(GlobalConstant.textSize * 10);
    textPaint.setColor(GlobalConstant.textColor);

    // draw text
    canvas.drawText(label, pointsCache[0], pointsCache[1], textPaint);
//    canvas.drawText(label, 13.603386f, 15.239999f, textPaint);
    Log.e("drawTextTT XXX", String.valueOf(xmin));
    Log.e("drawTextTT YYY", String.valueOf(ymin));
